...
def test_sql_filters_run_id():
  sql = fetch.build_sample_sql(
      "p.d.t", rows=5, run_id_col="run_id", run_id="r-1")
...
def test_main_dies_on_malformed_engine_label_before_touching_bq(
    monkeypatch, capsys):
