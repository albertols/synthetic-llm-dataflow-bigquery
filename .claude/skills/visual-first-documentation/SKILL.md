...
- Generated by the same committed `scripts/doc/make_<topic>_figures.py`, from a
...
```bash
uv run --no-sync python3 scripts/doc/make_<topic>_figures.py   # regenerate + validate palette
```
