...
def _draw_panel(ax,
  ...
  ax.axis("off")
  ax.set_title(
      title, color=INK, fontsize=11, fontweight="600", loc="left", pad=22)
  ax.text(
      0.18,
      1.0,
      subtitle,
  ...
  for name, (x, y) in NODES.items():
    ...
    ax.text(
        ...
        ha="center",
        va="center",
        color=text if name in generated else MUTED,
        fontsize=7,
        zorder=4)
