...
|---|---|---|---|---|---|
| 1 | [Building banking synthetic data on Dataflow — intro](01-building-banking-synthetic-data-intro.md) | The problem and constraints (privacy, no egress, self-hosted LLMs), Beam Summit 2025 framing, high-level architecture, the two engines at a glance, the `generation_plan` per-type tour, the flagship 0/10M-orphans teaser, glossary foundation (~12 terms) | `README.md`, ADR 0013/0014/0022/0028–0033 | `architecture-overview.png`, `generation-plan-routing.png`, `stats-inverse-cdf.png`, `fk-orphan-rate.png` | Draft |
