...
**Figures:** concept set (entropy/skew, inverse-CDF, epoch deciles, null patterns) regenerable via `scripts/make_source_stats_figures.py` — the design doc carries them with two-audience captions and code links.
