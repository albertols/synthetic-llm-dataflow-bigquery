...
- [0040 — Donated to the Dataflow Solution Guides; this repository stays the golden source (manifest-driven `/dsg-sync`, shared style and sensitive-content gates; amended 2026-09-19 after the first DSG review: one design document ships, one licence header, in-place publishing onto a PR under review)](0040-dsg-donation-golden-source-sync.md)
