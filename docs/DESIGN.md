...
| :-- | :-- | :-- |
| 0001 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [No managed GCP services in the serving path](adr/0001-no-managed-gcp-services.md) |
| 0002 | [§3 Serving](#3-serving-a-vllm-server-owned-by-the-engine) | [Open-weight model shortlist](adr/0002-gemma-4-model-shortlist.md) |
| 0003 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [Private container registry (withdrawn)](adr/0003-jfrog-image-registry.md) |
| 0004 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [Dataflow region](adr/0004-europe-west3-region.md) |
| 0005 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [Live SELECT for reference rows](adr/0005-live-select-reference-data.md) |
| 0006 | [§2 Engines](#2-engines-and-the-llm-as-a-distribution-estimator) | [`GenerationEngine` ABC and `ModelClient` Protocol](adr/0006-generation-engine-abc.md) |
| 0007 | [§9 ADR reference map](#9-adr-reference-map) | [One source of truth across docs and code](adr/0007-dry-documentation-policy.md) |
| 0008 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [Images are built in CI](adr/0008-ci-driven-builds.md) |
| 0009 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [One image for launcher and workers](adr/0009-single-flex-template-image.md) |
| 0010 | [§2 Engines](#2-engines-and-the-llm-as-a-distribution-estimator) | [Local smoke test on Apple Silicon](adr/0010-m4-local-smoke-mlx.md) |
| 0011 | [§3 Serving](#3-serving-a-vllm-server-owned-by-the-engine) | [Adopt Beam's vLLM handler (amended by 0014)](adr/0011-adopt-beam-vllm-model-handler.md) |
| 0012 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [Image build under network constraints (withdrawn)](adr/0012-enterprise-image-build.md) |
| 0013 | [§2 Engines](#2-engines-and-the-llm-as-a-distribution-estimator) | [The LLM as a distribution estimator](adr/0013-distribution-estimator-spine.md) |
| 0014 | [§3 Serving](#3-serving-a-vllm-server-owned-by-the-engine) | [The model client owns the vLLM server](adr/0014-vllm-model-client-owns-server.md) |
| 0015 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [Worker image in Artifact Registry](adr/0015-worker-image-via-artifact-registry.md) |
| 0016 | [§1 Architecture](#1-architecture-and-the-cpugpu-split) | [Images on Cloud Build](adr/0016-personal-gcp-cloud-build.md) |
| 0017 | [§2 Engines](#2-engines-and-the-llm-as-a-distribution-estimator) | [Own retrieval layer instead of `apache_beam.ml.rag`](adr/0017-custom-rag-layer-over-beam-ml-rag.md) |
| 0018 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Batched, parallel free-text pool builds](adr/0018-parallel-batched-freetext-pools.md) |
| 0019 | [§2 Engines](#2-engines-and-the-llm-as-a-distribution-estimator) | [Embedding population scoped to its consumers](adr/0019-rag-population-scoped-to-consumers.md) |
| 0020 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Free-text pools as a persisted artifact](adr/0020-freetext-pools-as-persisted-artifact.md) |
| 0021 | [§4 Relational generation](#4-relational-generation) | [Relational contract in column descriptions (superseded by 0032)](adr/0021-relational-contract-in-descriptions.md) |
| 0022 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Source table statistics as a generation input](adr/0022-stats-driven-generation.md) |
| 0023 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Pools reject against the full source domain](adr/0023-source-domain-pool-rejection.md) |
| 0024 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Structured prompt-constraint templates](adr/0024-structured-prompt-constraint-templates.md) |
| 0025 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Marginal fidelity by construction](adr/0025-marginal-fidelity-by-construction.md) |
| 0026 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Measurement first, then mask integrity](adr/0026-measurement-first-mask-integrity.md) |
| 0027 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Verification cycle and operational integrity](adr/0027-verified-wave4-operational-integrity.md) |
| 0028 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Constraint router and relational plan](adr/0028-constraint-router-relational-plan.md) |
| 0029 | [§4 Relational generation](#4-relational-generation) | [Launch scenarios for a relationship model](adr/0029-fk-model-scenarios-and-history-mappings.md) |
| 0030 | [§4 Relational generation](#4-relational-generation) | [Single-job relational generation](adr/0030-single-job-relational-generation.md) |
| 0031 | [§4 Relational generation](#4-relational-generation) | [Joint foreign-key draws](adr/0031-joint-fk-key-draws.md) |
| 0032 | [§8 Configuration](#8-configuration) | [Relationships are configuration](adr/0032-relationships-as-config.md) |
| 0033 | [§5 Fidelity](#5-fidelity-value-pools-and-constraints) | [Pool-ladder integrity at scale](adr/0033-pool-ladder-integrity-at-scale.md) |
| 0034 | [§6 Throughput](#6-throughput) | [One barrier, shared engines](adr/0034-generation-throughput-single-barrier-shared-engines.md) |
| 0035 | [§4 Relational generation](#4-relational-generation) | [Key capacity counts foreign-key-bound members](adr/0035-pk-capacity-fk-bound-members.md) |
| 0036 | [§4 Relational generation](#4-relational-generation) | [Parent-driven fan-out generation](adr/0036-parent-driven-fanout-generation.md) |
| 0037 | [§4 Relational generation](#4-relational-generation) | [Multi-parent children](adr/0037-multi-parent-children.md) |
