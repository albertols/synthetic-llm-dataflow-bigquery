...
### Fixes
- fix(dsg): maintainer-only attribution, one sync branch, current README status (#23)
...
_Evolution chart spans 9 prior tagged release(s) plus this one (execution_seconds, lower is better)._
