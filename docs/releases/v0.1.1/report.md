...
### Docs
- docs(revisit): README single entry point, evidence relocation, docs alignment, Medium articles layer (#14)
- docs(releases): v0.1.0 insights [release-report]
...
_Evolution chart spans 1 prior tagged release(s) plus this one (execution_seconds, lower is better)._
