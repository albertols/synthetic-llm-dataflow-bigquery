...
### Chores
- chore(release): publish GitHub Release notes from CHANGELOG.md + README badges
...
_Evolution chart spans 5 prior tagged release(s) plus this one (execution_seconds, lower is better)._
