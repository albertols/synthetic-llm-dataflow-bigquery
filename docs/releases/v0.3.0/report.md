...
### Features
- feat(relational): parent-driven fan-out, multi-parent children, and measured model adjustment (ADR 0035-0039)
...
_Evolution chart spans 4 prior tagged release(s) plus this one (execution_seconds, lower is better)._
