...
### Fixes
- fix(dsg): pylint clean on Python 3.14, as the DSG CI runs it (#24)
...
_Evolution chart spans 10 prior tagged release(s) plus this one (execution_seconds, lower is better)._
