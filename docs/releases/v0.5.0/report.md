...
### Features
- feat(dsg): manifest patches for DSG-side fixes under review (#25)
...
_Evolution chart spans 11 prior tagged release(s) plus this one (execution_seconds, lower is better)._
