...
### Chores
- chore(oss): genericize corporate-origin layers and gate sensitive content (#20)
...
_Evolution chart spans 6 prior tagged release(s) plus this one (execution_seconds, lower is better)._
