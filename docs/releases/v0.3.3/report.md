...
### Style
- style: adopt Google Python style (yapf + pylint with the DSG pylintrc) (#21)
...
_Evolution chart spans 7 prior tagged release(s) plus this one (execution_seconds, lower is better)._
