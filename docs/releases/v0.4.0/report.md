...
### Features
- feat(dsg): Dataflow Solution Guides overlay, sync tool and /dsg-sync (ADR 0040) (#22)
...
_Evolution chart spans 8 prior tagged release(s) plus this one (execution_seconds, lower is better)._
