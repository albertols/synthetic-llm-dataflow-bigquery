...
share the `A9A9AA9AA9…` stem; dominant values share a literal `E2F` prefix),
...
band. There is no structured way to say "exactly three spaces", "prefix `E2F`",
