...
```mermaid
flowchart LR
  PAT["⚪ pattern<br/>E2F .. 16^20"] --> AUT["⚙️ compile<br/>automaton walk"]
  FAM["⚪ families<br/>E2F3 .57 / E2F1 .42<br/>2301 .007"] --> AUT
...
`families` shares — the E2F3/E2F1/2301 split the prose currently carries
as unparseable percentages. A dedup set gives uniqueness at any
`num_rows` (the E2F space is 3.6e24; collisions are negligible, the set
...
| 7 | Family shares land within sampling error (E2F3 ≈ .57, E2F1 ≈ .42, 2301 ≈ .007) | stats_diff on re-run |
