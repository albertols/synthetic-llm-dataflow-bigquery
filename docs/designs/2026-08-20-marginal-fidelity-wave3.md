...
| E3 | Mask-table fills drew from **column-wide** class alphabets — positional literals (`E2F3` prefix, v4 nibbles) unreachable (fig 2 right, fig 4) | `text_shapes.py::positional_alphabets` narrows every class fill to the position's observed charset; singletons pin as literals |
