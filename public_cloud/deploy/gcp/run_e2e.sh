...
log "    --region ${REGION} --pk <pk_cols> --job-id ${JOB_ID} --run-id ${RUN_ID} --out runs/${JOB_ID}/e2e_gcp_metrics.json"
log "  then e2e_validation_analysis.py + e2e_bundle_export.py -> runs/${JOB_ID}/"
